...
def network_docker_binary_basename(protocol: str, binary_tag: str) -> str:
    """Basename matching create_dockerfile COPY line ({protocol}d.{tag})."""
    return f"{protocol}d"
...
def build_network_start_sh(
    ...
    bin_base = network_docker_binary_basename(protocol, binary_tag)
